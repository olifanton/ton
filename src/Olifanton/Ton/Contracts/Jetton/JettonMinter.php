...
class JettonMinter extends AbstractContract
{
     ...
     * @throws ContractException
     */
    public function createMintBody(MintOptions $options): Cell
    {
        try {
            $body = (new Builder())
                ->writeUint(21, 32)
     ...
     * @throws ContractException
     */
    public function createChangeAdminBody(?Address $newAdminAddress, int $queryId = 0): Cell
    {
        try {
            return (new Builder())
                ->writeUint(2, 32)
     ...
     * @throws ContractException
     */
    public function createEditContentBody(string $jettonContentUrl, int $queryId = 0): Cell
    {
        try {
            $body = (new Builder())
                ->writeUint(4, 32)
